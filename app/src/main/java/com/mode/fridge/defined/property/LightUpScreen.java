...
public class LightUpScreen extends PropertyOperable<Vstring> {

    public static PropertyType TYPE = ViomiDefined.Property.LightUpScreen.toPropertyType();
