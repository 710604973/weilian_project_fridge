...
public class ComReceiveData extends PropertyOperable<Vstring> {

    public static PropertyType TYPE = ViomiDefined.Property.ComReceiveData.toPropertyType();
