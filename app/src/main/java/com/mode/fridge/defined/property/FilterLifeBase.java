...
public class FilterLifeBase extends PropertyOperable<Vint> {

    public static PropertyType TYPE = ViomiDefined.Property.FilterLifeBase.toPropertyType();
