...
public class PlayLightMusic extends PropertyOperable<Vstring> {

    public static PropertyType TYPE = ViomiDefined.Property.PlayLightMusic.toPropertyType();
