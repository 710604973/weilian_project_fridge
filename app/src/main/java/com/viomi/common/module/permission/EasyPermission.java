 ...
 */
package com.viomi.common.module.permission;
...
public class EasyPermission {
    ...
    public static void requestPermissions(final Object object, String rationale,
        ...
        final List<String> deniedPermissions =
                PermissionUtil.findDeniedPermissions(PermissionUtil.getActivity(object), permissions);


        boolean shouldShowRationale = false;
        for (String perm : deniedPermissions) {
            shouldShowRationale =
                    shouldShowRationale || PermissionUtil.shouldShowRequestPermissionRationale(object, perm);
        }

        if (PermissionUtil.isEmpty(deniedPermissions)) {
            mCallBack.onPermissionGranted(requestCode, Arrays.asList(permissions));
        } else {
    ...
    public static boolean checkDeniedPermissionsNeverAskAgain(final Object object, String rationale,
                                                              List<String> deniedPerms, boolean isCancelFinishActivity) {
        return checkDeniedPermissionsNeverAskAgain(object, rationale, R.string.button_setting,
                                                   android.R.string.cancel, deniedPerms,isCancelFinishActivity);
    }
    ...
    public static boolean checkDeniedPermissionsNeverAskAgain(final Object object, String rationale,
        ...
        for (String perm : deniedPerms) {
            ...
            if (!shouldShowRationale) {
                final Activity activity = PermissionUtil.getActivity(object);
                if (null == activity) {
                    return true;
                }
