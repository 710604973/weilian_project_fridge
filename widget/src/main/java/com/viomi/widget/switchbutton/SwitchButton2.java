package com.viomi.widget.switchbutton;
...
public class SwitchButton2 extends CompoundButton {
    ...
    public SwitchButton2(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void init(AttributeSet attrs) {
        ...
        TypedArray ta = attrs == null ? null : getContext().obtainStyledAttributes(attrs, R.styleable.SwitchButton2);
        if (ta != null) {
            thumbDrawable = ta.getDrawable(R.styleable.SwitchButton2_kswThumbDrawable);
            thumbColor = ta.getColorStateList(R.styleable.SwitchButton2_kswThumbColor);
            margin = ta.getDimension(R.styleable.SwitchButton2_kswThumbMargin, margin);
            marginLeft = ta.getDimension(R.styleable.SwitchButton2_kswThumbMarginLeft, margin);
            marginRight = ta.getDimension(R.styleable.SwitchButton2_kswThumbMarginRight, margin);
            marginTop = ta.getDimension(R.styleable.SwitchButton2_kswThumbMarginTop, margin);
            marginBottom = ta.getDimension(R.styleable.SwitchButton2_kswThumbMarginBottom, margin);
            thumbWidth = ta.getDimension(R.styleable.SwitchButton2_kswThumbWidth, thumbWidth);
            thumbHeight = ta.getDimension(R.styleable.SwitchButton2_kswThumbHeight, thumbHeight);
            thumbRadius = ta.getDimension(R.styleable.SwitchButton2_kswThumbRadius, Math.min(thumbWidth, thumbHeight) / 2.f);
            backRadius = ta.getDimension(R.styleable.SwitchButton2_kswBackRadius, thumbRadius + density * 2f);
            backDrawable = ta.getDrawable(R.styleable.SwitchButton2_kswBackDrawable);
            backColor = ta.getColorStateList(R.styleable.SwitchButton2_kswBackColor);
            backMeasureRatio = ta.getFloat(R.styleable.SwitchButton2_kswBackMeasureRatio, backMeasureRatio);
            animationDuration = ta.getInteger(R.styleable.SwitchButton2_kswAnimationDuration, animationDuration);
            fadeBack = ta.getBoolean(R.styleable.SwitchButton2_kswFadeBack, true);
            tintColor = ta.getColor(R.styleable.SwitchButton2_kswTintColor, tintColor);
            textOn = ta.getString(R.styleable.SwitchButton2_kswTextOn);
            textOff = ta.getString(R.styleable.SwitchButton2_kswTextOff);
            textMarginH = Math.max(textMarginH, backRadius / 2);
            textMarginH = ta.getDimension(R.styleable.SwitchButton2_kswTextMarginH, textMarginH);
            autoAdjustTextPosition = ta.getBoolean(R.styleable.SwitchButton2_kswAutoAdjustTextPosition, autoAdjustTextPosition);
            ta.recycle();
        }
        ...
        if (!mIsThumbUseDrawable && mThumbColor == null) {
            mThumbColor = SwitchUtil.generateThumbColorWithTintColor(mTintColor);
        ...
        if (!mIsBackUseDrawable && mBackColor == null) {
            mBackColor = SwitchUtil.generateBackColorWithTintColor(mTintColor);
