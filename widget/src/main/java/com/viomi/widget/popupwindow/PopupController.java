package com.viomi.widget.popupwindow;
...
public class PopupController {
    ...
    private void setOutsideTouchable(boolean touchable) {
        ...
        popupWindow.setOutsideTouchable(touchable);// 设置 outside 可点击
    ...
    static class PopupParams {
        ...
        public int animationStyle;// 动画 id
        public View mView;
        ...
        public void apply(PopupController controller) {
            ...
            controller.setOutsideTouchable(isTouchable);// 设置 outside 可点击
            if (isShowBg) {
                // 设置背景
